...
'color1 should be the congruent color for each letter!
    ...
    ' colors for N
    n_color_1 = RGB(0, 155, 255) 'blue
    n_color_2 = RGB(230, 0, 0) 'red
    n_color_3 = RGB(0, 181, 0) 'green
    n_color_4 = RGB(255, 143, 0) 'orange
    
    ' colors for A
    a_color_1 = RGB(255, 143, 0) 'orange
    a_color_2 = RGB(230, 0, 0) 'red
    a_color_3 = RGB(0, 181, 0) 'green
    a_color_4 = RGB(0, 155, 255) 'blue
    
    ' colors for R
    r_color_1 = RGB(0, 181, 0) 'green
    r_color_2 = RGB(255, 143, 0) 'orange
    r_color_3 = RGB(0, 155, 255) 'blue
    r_color_4 = RGB(230, 0, 0) 'red
        ...
        Do While Selection.Find.Execute
            ...
            If rndNumber <= 75 Then
                Selection.Font.Color = a_color_1
            ElseIf rndNumber > 75 And rndNumber <= 84 Then
                Selection.Font.Color = a_color_2
            ElseIf rndNumber > 84 And rndNumber <= 92 Then
